...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff3853A4);
  static const Color secondary = Color(0xffEF1E1F);
  ...
  static const Color grad1Color = Color(0xffEF1E1F);
  static const Color grad2Color = Color(0xffEF1E1F);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xffEF1E1F);
