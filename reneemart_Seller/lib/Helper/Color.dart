...
const Color primary =Color(0xff3853A4);
const Color secondary = Color(0xffEF1E1F);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xff3853A4);
const Color grad2Color = Color(0xff3853A4);
