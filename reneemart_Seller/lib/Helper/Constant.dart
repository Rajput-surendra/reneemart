final String appName = 'ReneeMart Seller';

final String packageName = 'com.reneemart.seller';

final String iosPackage = 'com.reneemart.seller';
...
final String baseUrl = 'https://reneemegamart.com/seller/app/v1/api/';
